...
This file contains tasks and ideas related to the development
environment, documentation, development tools, and other parts
of the project that are not features of okoze itself.

It is intentionally separate from `features.md`.
